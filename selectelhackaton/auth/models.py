...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def name(self):
        ...
        return self.email[:self.email.find('@')] # dodo101000101@gmail.com -> dodo101000101
    ...
    def guess_display_name(self):
        ...
        if self.first_name and self.last_name:
            ...
            dn = self.email[:self.email.find('@')] # dodo101000101@gmail.com -> dodo101000101
...
def set_initial_user_names(request, user, sociallogin=None, **kwargs):
    ...
    if sociallogin:
        ...
        if sociallogin.account.provider == 'github':
            ...
            user.display_name = sociallogin.account.extra_data['login']
            #user.last_name = sociallogin.account.extra_data['last_name'] #see: https://developer.github.com/v3/users/
            verified = sociallogin.account.extra_data['email']
            #email =
